...
- **Files** — site-wide settings that aren't really "pages": Site Settings, Navigation Labels,
...
of its Name if you want different wording.
...
- **Section Page Headers** — the intro text shown at the top of `/blog`, `/events`,
  `/services`, etc.
